...
class Mechanic(models.Model):
    ...
    front_aadhar = models.FileField(upload_to="aadhar/", blank=True, null=True)
    back_aadhar = models.FileField(upload_to="aadhar/", blank=True, null=True)
    pancard = models.FileField(upload_to="aadhar/", blank=True, null=True)
