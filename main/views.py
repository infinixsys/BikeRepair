...
def send_otp(phone):
    ...
    if phone:
        ...
        phone = str(phone)
        otp_key = str(key)
        API_Key = "XVqxz6mGg8Z24uiDenBAYPIb0KpMJjQHNlWE1f3vSF9Os7UTkyKkgiT2owNJFLtS4XjZGbuIyxr9Pzf5"
        link = f'https://www.fast2sms.com/dev/bulkV2?authorization={API_Key}&variables_values={otp_key}&route=otp&numbers={phone}'
